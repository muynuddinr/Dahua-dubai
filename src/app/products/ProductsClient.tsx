...
export function ProductsClient({ initialCategories, navbarCategories }: ProductsClientProps) {
    ...
    // single hero image
    const heroImage = '/images/Product1.png';
    ...
    return (
        <div className="min-h-screen">
            {/* Enhanced Full Banner Image Hero */}
            <div className="relative h-screen overflow-hidden">
                {/* Image Background - single static image */}
                <div
                ...
                <div className="relative h-full flex items-center px-6 lg:px-12 z-10">
                    ...
                    >
                        ...
                        >
                            Carefully engineered solutions for industrial needs — browse our complete collection.
                        </motion.p>
                    </motion.div>
                </div>
            ...
            {/* Content Section */}
            <div id="products-section" className="relative bg-gradient-to-br from-slate-50 to-slate-100">
                        ...
                        >
                            <div>
                                ...
                                <p className="text-lg text-slate-600 max-w-2xl">
                                    Browse through our extensive range of <span className='text-red-500'>industrial solutions</span>
                                </p>
                            </div>
                        </motion.div>
