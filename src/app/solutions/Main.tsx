...
const Page = () => {
  ...
  const categoryRefs = [categoryRef1, categoryRef2, categoryRef3, categoryRef4, categoryRef5];
...
>
  ...
  <p className="text-base text-gray-700 leading-relaxed mb-4">
    Our enterprise networking solutions deliver reliable, high-performance connectivity that scales with your business needs. 
    We implement secure, resilient network architectures that support your critical operations while ensuring data integrity 
